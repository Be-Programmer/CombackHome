...
//this is booting receiver that acts to start this application when the device boot
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(Intent.ACTION_BOOT_COMPLETED)) {
            if(isSetting(context)) {  //if user set destination then start service , else then act nothing
